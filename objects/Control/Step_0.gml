...
// oL = instance_nearest(NotesBar.xp, ycalc, oPlayerNote);
// oD = instance_nearest(NotesBar.xp, ycalc, oPlayerNote);
// oU = instance_nearest(NotesBar.xp, ycalc, oPlayerNote);
// oR = instance_nearest(NotesBar.xp, ycalc, oPlayerNote);
#region speed
